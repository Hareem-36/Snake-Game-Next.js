...
export default function SnakeGame() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-br from-pink-200 to-pink-200">
      <div className="bg-sky-600 rounded-lg shadow-lg p-8 w-full max-w-md">
        <div className="flex items-center justify-between mb-6">
          <div className="text-4xl font-bold text-slate-50">Snake Game</div>
        ...
        <div className="bg-violet-100 rounded-lg p-4 grid grid-cols-10 gap-1">
        ...
        <div className="flex items-center justify-between mt-7 text-blue-50 font-bold text-2xl">
          <div>Score: {score}</div>
